...
export default function CreateTaskModal({ isOpen, onClose, parentTask, currencies }) {
  const { t } = useTrans();
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    post(route('tasks.store-child', parentTask.id), {
      onSuccess: () => {
        reset();
        onClose();
      },
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <InputLabel htmlFor="child_task_name" value={t('task_name')} />
          <TextInput
            id="child_task_name"
            type="text"
            name="name"
        ...
        <div className="mb-4">
          <InputLabel htmlFor="child_task_price" value={t('price_optional')} />
          <TextInput
            id="child_task_price"
            type="number"
            step="0.01"
        ...
        <div className="mb-4">
          <InputLabel htmlFor="child_task_note" value={t('note_optional')} />
          <TextArea
            id="child_task_note"
            name="note"
            value={data.note || ''}
