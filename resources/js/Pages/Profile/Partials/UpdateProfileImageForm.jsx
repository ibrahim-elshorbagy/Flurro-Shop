        ...
        <div>
          ...
          <div className="mt-2 flex items-center gap-6">
            ...
            {user.image_url ? (
              ...
              <div className="h-20 w-20 text-white rounded-full bg-purple-200 flex items-center justify-center">
            ...
            {previewUrl && (
              <div>
                <img
                  src={previewUrl}
                  alt="Preview"
                  className="h-20 w-20 rounded-full object-cover border-2 border-purple-400"
                />
              </div>
            )}
          </div>
          ...
          <div className="mt-4">
            ...
            <label
              htmlFor="image"
              className="inline-flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-md cursor-pointer hover:bg-purple-700"
            >
