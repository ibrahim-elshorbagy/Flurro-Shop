  ...
  return (
    <div className="flex flex-col">
      <button
        ...
        className={`flex items-center justify-between rounded-xl gap-2 px-2 py-1.5 text-sm font-medium underline-offset-2 focus:outline-hidden focus-visible:underline ${isExpanded || isAnySubmenuActive || isParentRouteActive ? 'text-black bg-purple-500/10' : 'text-neutral-800 hover:bg-purple-500/5 hover:text-black'}`}
      >
