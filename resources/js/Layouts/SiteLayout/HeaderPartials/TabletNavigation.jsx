...
export default function TabletNavigation() {
  ...
  return (
    <>
      {/* Mobile Menu Trigger */}
      <div className="flex justify-between items-center p-4 border-b border-b-neutral-300 bg-purple-50 md:hidden">
        <div className='w-24'>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-3 py-2 rounded-full bg-purple-500 text-white shadow-md"
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`md:hidden fixed inset-0 z-[60] bg-purple-50 text-neutral-800 transition-all duration-300 ease-in-out
        ${isMobileMenuOpen ? "opacity-100 visible" : "opacity-0 invisible"}`}
      >
        <nav className="flex flex-col h-full ">
          {/* Header with Logo + Close */}
          <div className="flex justify-between items-center px-5 py-4 border-b border-neutral-400 bg-purple-50">
            <div className="w-32">
              <Link href={route("home")} >
                <ApplicationLogo />
              </Link>
          ...
          {/* Menu Links */}
          <ul className="flex flex-col divide-y divide-neutral-200 bg-purple-50">
            <li>
              <MenuNavLink
                href="#home"
          ...
          {/* Settings Section */}
          <div className="border-t border-neutral-400 bg-purple-50">
